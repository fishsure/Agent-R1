...
## Get Started
- [Environment Setup](https://github.com/0russwest0/Agent-R1/tree/main/docs/getting_started/installation.md)
- [Quick Start: Try Default Search Tool on HotpotQA](https://github.com/0russwest0/Agent-R1/tree/main/docs/getting_started/quickstart.md)
...
See the [extending doc](https://github.com/0russwest0/Agent-R1/tree/main/docs/extend/extending.md) for details.
