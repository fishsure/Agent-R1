from agent_r1.tool.tools.crag_mock_api.tools.financetools import FinanceTools
from agent_r1.tool.tools.crag_mock_api.tools.musictools import MusicTools
from agent_r1.tool.tools.crag_mock_api.tools.movietools import MovieTools
from agent_r1.tool.tools.crag_mock_api.tools.sportstools import SportsTools
from agent_r1.tool.tools.crag_mock_api.tools.generaltools import find_date_from_text, find_date_from_text_all, extract_date, extract_date_, get_last_week_dates, get_last_month_dates, get_this_week_dates, get_this_month_dates
from agent_r1.tool.tools.crag_mock_api.prompts import NER_MOVIE_SYSTEM_PROMPT, NER_MOVIE_USER_PROMPT, NER_MUSIC_SYSTEM_PROMPT, NER_MUSIC_USER_PROMPT, NER_SPORTS_SYSTEM_PROMPT, NER_SPORTS_USER_PROMPT, NER_FINANCE_SYSTEM_PROMPT, NER_FINANCE_USER_PROMPT, NER_OPEN_SYSTEM_PROMPT, NER_OPEN_USER_PROMPT
import re
